package com.jvr.booking.bouncer.dto;
...
public class BouncerRequest {
    ...
    // File paths
    private MultipartFile bouncerAgencyPhoto;
	...
	public MultipartFile getBouncerAgencyPhoto() {
		return bouncerAgencyPhoto;
	}

	public void setBouncerAgencyPhoto(MultipartFile bouncerAgencyPhoto) {
